...
IntersectionResult Intersect(const Scene& scene, Ray& ray, AnyHitCallBack any_hit_program)
{
    ...
    else if (scene.static_bvh_type == StaticBVHType::LBVH)
    {
        ...
        //     auto mesh_intesect_tri = [&scene, &mesh_id, material_per_slot, &trans](const Ray& ray, const int&
        //     mesh_idx,
        ...
        //                                  {
        //         return IntersectMesh(ray, scene.sphere_meshs[mesh_id.id], mesh_idx, material_per_slot,
        //         any_hit_program,
        //                              trans);
        //     };
        ...
        //         return BVHIntersect(mesh_ray, scene.static_mesh_trees[mesh_id.id], any_hit_program,
        //         mesh_intesect_tri);

        //     case MeshTypes::SPHERE:
        //         auto number_triangle_meshs = scene.triangle_meshs.size();

        //         return BVHIntersect(mesh_ray, scene.static_mesh_trees[mesh_id.id + number_triangle_meshs],
