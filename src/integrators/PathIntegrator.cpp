...
namespace integrators
{
    ...
    core::SpectrumPasses PathIntegrator::Integrate(const core::Ray& ray,const std::shared_ptr<core::ISampler>& sampler,core::MemoryArea& memory) const 
    {
        ...
        if(surfaceInteraction.has_value()){
            ...
            core::Vec3 incident_dir = bsdf->SampleIncidentDirection(-ray.Direction, sampler->Get2DSample());
            ...
            {
                core::SpectrumPasses subray_radiance = Integrate(incident_ray,sampler, memory);
