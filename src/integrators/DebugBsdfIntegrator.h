...
namespace integrators {
    ...
    class DebugBsdfIntegrator : public core::IIntegrator
    {
    public:
        ...
        virtual core::Vec3 PixelEffect(core::SurfaceProperties& properties,const core::Ray& ray,const core::Vec2& sample,BsdfMemoryPtr& bsdf_memory, 
