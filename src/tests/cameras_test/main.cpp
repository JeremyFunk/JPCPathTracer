...
namespace jpc_tracer {
    ...
    {
        auto sampler = MakeRef<DebugSampler>();
        auto camera = MakeRef<ProjectionCamera>(3,3,1);
    ...
    {
        auto sampler = MakeRef<DebugSampler>();
        auto camera = MakeRef<ProjectionCamera>(3,4,1);
    ...
    {
        auto sampler = MakeRef<DebugSampler>();
        auto camera = MakeRef<ProjectionCamera>(4,3,1);
