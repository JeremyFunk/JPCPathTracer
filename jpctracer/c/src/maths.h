...
#include <stdbool.h>
// ungenau wie scheiße
static inline bool solveQuadratic(const float a,
                                  const float b,
                                  const float c,
                                  float*      x0,
                                  float*      x1)
...
static inline void interpolate3d(vec3  v1,
                                 vec3  v2,
                                 vec3  v3,
                                 float u,
                                 float v,
...
static inline void interpolate2d(vec2  v1,
                                 vec2  v2,
                                 vec2  v3,
                                 float u,
                                 float v,
...
static inline void mat4_ucopy(float4x4 mat, mat4 dest)
{
    dest[0][0] = mat[0][0];
    dest[1][0] = mat[1][0];
    dest[0][1] = mat[0][1];
